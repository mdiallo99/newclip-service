...
* The original package name 'com.example.authentication-app' is invalid and this project uses 'com.example.authenticationapp' instead.
...
* [Authenticating a Profile with LDAP](https://spring.io/guides/gs/authenticating-ldap/)
