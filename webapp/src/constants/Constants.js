 ...
 * All endpoints
 */
const USER_LIST_ENDPOINT = "/proxy/api/user/list";
const USER_PROFILE_ENDPOINT = "/proxy/api/user/";
const ADD_USER_ENDPOINT = "/api/user/add";
const COMPANY_LIST_ENDPOINT= "/api/sylob/companyList";
const ADD_COMPANY_ENDPOINT= "/proxy/api/company/add";
...
const ADD_SYLOB_ARTICLE_ENDPOINT = "/proxy/api/sylob/article/add";
const SYLOB_KIT_LIST_ENDPOINT = "/api/sylob/kitList";
const FIND_KIT_BY_LABEL_ENDPOINT = "/api/sylob/kit/"

// Local
const PROXY_USER_LIST_ENDPOINT = "/proxy/api/user/list";
